...
class PodcastsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create podcast" do
    assert_difference('Podcast.count') do
      post podcasts_url, params: { podcast: { date: @podcast.date, description: @podcast.description, fichier: @podcast.fichier, genre: @podcast.genre, id_podcast: @podcast.id_podcast, image: @podcast.image } }
    end
  ...
  test "should update podcast" do
    patch podcast_url(@podcast), params: { podcast: { date: @podcast.date, description: @podcast.description, fichier: @podcast.fichier, genre: @podcast.genre, id_podcast: @podcast.id_podcast, image: @podcast.image } }
