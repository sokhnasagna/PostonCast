...
class LecturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lecture" do
    assert_difference('Lecture.count') do
      post lectures_url, params: { lecture: { enLecture: @lecture.enLecture, id: @lecture.id, id_podcast: @lecture.id_podcast, id_user: @lecture.id_user } }
    end
  ...
  test "should update lecture" do
    patch lecture_url(@lecture), params: { lecture: { enLecture: @lecture.enLecture, id: @lecture.id, id_podcast: @lecture.id_podcast, id_user: @lecture.id_user } }
